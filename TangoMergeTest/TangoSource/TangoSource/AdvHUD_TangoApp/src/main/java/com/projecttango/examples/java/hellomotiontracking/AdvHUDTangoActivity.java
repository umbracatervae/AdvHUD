 ...
 */
public class AdvHUDTangoActivity extends Activity {

    private static final String TAG = AdvHUDTangoActivity.class.getSimpleName();
    ...
    protected void onResume() {
        ...
        mTango = new Tango(AdvHUDTangoActivity.this, new Runnable() {
            ...
            @Override
            public void run() {
                synchronized (AdvHUDTangoActivity.this) {
                    try {
    ...
    private TangoConfig setupTangoConfig(Tango tango) {
        // Create a new Tango Configuration and enable the AdvHUDTangoActivity API.
    ...
    private void logPose(TangoPoseData pose) {
        ...
        stringBuilder.append("\n" + Math.toDegrees(2*Math.asin(orientation[0])));
